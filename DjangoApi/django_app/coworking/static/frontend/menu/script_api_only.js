// script.js — API-only version: Reserve/Cancel using backend, ICS link + live events
(function(){
  ...
  // --- ICS helper (shared with dashboard) ---
  ...
  // --- Build seats view (reserved vs free for selected date) ---
  ...
  // --- Load reservations for selected day and render seats ---
  ...
  // --- Cancel by ID (if Cancel page reuses this script) ---
