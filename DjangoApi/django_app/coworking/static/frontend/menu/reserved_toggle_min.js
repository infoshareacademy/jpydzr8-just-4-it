// reserved_toggle_persist.js — lekko i trwale: zapis w localStorage + jednorazowy render
(function(){
  ...
  // Jednorazowy render — tylko przy wejściu/odświeżeniu
  function renderFromStorageOnce(){
    ...
    tiles.forEach(el=>{
      ...
      // aktualizuj tylko te, które dotyczą rezerwacji
