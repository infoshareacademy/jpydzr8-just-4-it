...
/**
 * registration_form_v2.js
 * More tolerant field detection for registration.
 * - Finds email/password fields even if names differ
 * - Supports one or two password fields
 * - CSRF handling + JSON submit to /api/auth/register
...
(function () {
  ...
  function findPasswordFields(form) {
    ...
    // Generic fallbacks: take password inputs in DOM order
