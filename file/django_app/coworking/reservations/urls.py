...
urlpatterns = [
    ...
    path('reservation/<str:res_id>/ics/', views.reservation_ics, name='reservation_ics'),
    ...
    path('recurring-reservations/select-desk/', views.select_desk_for_recurring, name='select_desk_recurring'),
    ...
    path('notifications/subscribe-ui/', lambda r: __import__('django.shortcuts').shortcuts.render(r, 'reservations/subscribe_push.html'), name='subscribe_push_ui'),
