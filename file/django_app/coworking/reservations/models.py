...
class ConferenceRoom(models.Model):
    ...
    def get_translated_description(self):
        ...
        # Mapowanie standardowych opisów na tłumaczenia
        if self.description == "Domyślna sala konferencyjna dla piętra" or self.description == "Default conference room for floor":
            return _("Default conference room for floor")
        # Jeśli opis jest już w języku docelowym lub jest niestandardowy, zwróć go bez zmian
