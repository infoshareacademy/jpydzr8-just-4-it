...
from .mobile_views import (
    ...
    mobile_notifications, modern_dashboard, admin_control_center
)
from .report_views import (
    generate_report_api, download_report, list_reports, generate_user_report_api
)
...
urlpatterns = [
    ...
    path('admin/generate-user-report', generate_user_report_api, name='generate_user_report_api'),
