...
WEBPUSH_VAPID_CLAIM = os.getenv('WEBPUSH_VAPID_CLAIM', f"mailto:{os.getenv('WEBPUSH_CONTACT_EMAIL', 'admin@example.com')}")
...
if not WEBPUSH_ENABLED:
    print("ℹ️  INFO: Web Push (VAPID) keys not configured. Browser push notifications are disabled.")
    print("   Set WEBPUSH_VAPID_PUBLIC_KEY, WEBPUSH_VAPID_PRIVATE_KEY and WEBPUSH_VAPID_CLAIM in your environment to enable them.")
