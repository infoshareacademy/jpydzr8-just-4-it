...
class DashboardManager {
  ...
  startAutoRefresh() {
    // Auto-refresh summary and stats every 30 seconds
  ...
  bindRealTimeEvents() {
    // Listen for reservation events and refresh dashboard immediately
  ...
  async cancelReservation(reservationId) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        window.dispatchEvent(new CustomEvent('reservation:deleted', { 
